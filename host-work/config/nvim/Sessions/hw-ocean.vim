" ~/.dotfiles/host-work/config/nvim/Sessions/hw-ocean.vim:
" Vim session script.
" Created by session.vim 2.13.1 on 07 May 2021 at 18:18:18.
...
exe 'vert 2resize ' . ((&columns * 199 + 118) / 237)
exe '3resize ' . ((&lines * 30 + 24) / 49)
exe 'vert 3resize ' . ((&columns * 37 + 118) / 237)
...
wincmd w
argglobal
if bufexists("HW3.tex") | buffer HW3.tex | else | edit HW3.tex | endif
setlocal fdm=expr
setlocal fde=vimtex#fold#level(v:lnum)
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 61 - ((36 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
wincmd w
argglobal
if bufexists("term://.//299003:ipython") | buffer term://.//299003:ipython | else | edit term://.//299003:ipython | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 206 + 118) / 237)
exe 'vert 2resize ' . ((&columns * 30 + 118) / 237)
argglobal
setlocal fdm=expr
...
84
silent! normal! zo
let s:l = 87 - ((21 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
...
setlocal nofen
silent! normal! zE
let s:l = 3194 - ((23 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3194
