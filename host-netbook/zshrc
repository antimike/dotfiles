...
plugins=(git colorize command-not-found copybuffer copydir copyfile dnf extract github git-prompt pip safe-paste sudo taskwarrior themes vi-mode web-search z zsh_reload zsh-syntax-highlighting)
# Plugins to consider:
