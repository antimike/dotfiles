...
" Vim session script.
" Created by session.vim 2.13.1 on 07 March 2021 at 03:43:18.
...
badd +4 ~/texmf/tex/latex/antimike/pset.cls
badd +52 term://.//11567:/bin/zsh;\#neoterm-1
badd +1 ~/.gnupg/gpg-agent.conf
badd +1 ~/.gnupg/sshcontrol
badd +18 term://.//30543:/bin/zsh;\#neoterm-1
argglobal
%argdel
$argadd ~/.ghci
set stal=2
...
normal! 026|
lcd ~/.dotfiles
tabedit ~/.dotfiles/config/nvim/init.cmdline
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/
tabedit ~/texmf/tex/latex/antimike/pset.cls
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
